...
public class ActividadBdDAO implements ActividadDAO{
    ...
    @Override
    public void eliminar(Actividad a) throws DAOException {
        PreparedStatement stmt = null;
        int rows = 0;
        try {
...
//                throw new DAOException("No se encontro el registro");
    ...
    @Override
    public List<Actividad> obtenerLista(Integer a) throws DAOException {return null;}

    @Override
    public Actividad obtenerUser(String user) throws DAOException {return null;}
